...
model.fit(train_X,train_y.values.ravel(),plot=True, eval_set=(test_X, test_y))
...
f.write("CatBoost - RMSE obtained="+str(error))
print("RMSE :",error)
...
data["CatBoost"]=pred_delivery_date
...
compare.to_csv("CatBoost.csv",sep="\t") #saving the csv
