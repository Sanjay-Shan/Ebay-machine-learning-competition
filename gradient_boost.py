...
model = make_pipeline(StandardScaler(),GradientBoostingRegressor(random_state=10)) #66.88
...
f.write("GradientBoost - RMSE obtained ="+str(error))
print("RMSE :",error)
...
data["GBoost"]=pred_delivery_date
...
compare.to_csv("GBoost.csv",sep="\t") #saving the csv
